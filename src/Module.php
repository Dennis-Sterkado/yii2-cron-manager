...
namespace sterkado\crontab;

use sterkado\crontab\components\RouteExtractor;
...
class Module extends \yii\base\Module
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'sterkado\crontab\controllers';
    ...
    public function init()
    {
        ...
        if (\Yii::$app instanceof \yii\console\Application) {
            $this->controllerNamespace = 'sterkado\crontab\commands';
        }
    ...
    /**
     * Absolute console route to execution script (sterkado\crontab\commands\ExecController)
     * @return string
     */
